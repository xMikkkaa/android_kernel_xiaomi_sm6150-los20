...
MAKE_ARGS=(
    ...
    KCFLAGS="-Wno-error=fortify-source -Wno-error=sizeof-pointer-memaccess -Wno-error=strict-prototypes -Wno-enum-conversion -Wno-error=default-const-init-field-unsafe -Wno-default-const-init-field-unsafe -Wno-error=default-const-init-var-unsafe -Wno-default-const-init-var-unsafe"
)
